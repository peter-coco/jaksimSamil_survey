    ...
    <BrowserRouter>
      <AppWrap>
        <Routes>
          ...
          {/* {pageState === 'home' && <Home setPageState={setPageState} />}
          {pageState === 'survey' && (
            <Survey setResultType={setResultType} setPageState={setPageState} />
          )}
          {pageState === 'introduce' && <Introduce setPageState={setPageState} />}
          {pageState === 'result' && <Result resultType={resultType} setPageState={setPageState} />} */}
        </Routes>
      </AppWrap>
    </BrowserRouter>
  );
